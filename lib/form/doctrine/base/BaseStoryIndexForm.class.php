...
/**
 * StoryIndex form base class.
 *
 * @method StoryIndex getObject() Returns the current form's model object
 *
 * @package    c4foaf
 * @subpackage form
 ...
 */
class BaseStoryIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('story_index[%s]');
