...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@suggest_connection') ?>">Suggest a connection</a></li>
</ul>
<?php end_slot();?>
...
<div class="span-12">
		...
		<div class="span-12" id="block-044">
			...
			<div class="inner">
				<h2 class="sIFR-c4">Suggest a connection</h2>
			</div>
		...
		<div class="span-12">
                ...
                <div class="search-string">
                		<div class="inner clearfix">
                   			<p class="sIFR-c4">Suggest a connection</p>
                     		<p class="hidden">Suggest a connection</p>
                   	</div>
