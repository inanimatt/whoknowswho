...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@report') ?>">Report a mistake</a></li>
</ul>
<?php end_slot();?>
...
<div class="span-12">
		...
		<div class="span-12" id="block-044">
			...
			<div class="inner">
				<h2 class="sIFR-c4">Report a mistake</h2>
			</div>
		...
		<div class="span-12">
                ...
                <div class="search-string">
                		<div class="inner clearfix">
                   			<p class="sIFR-c4">Report a mistake</p>
                     		<p class="hidden">Report a mistake</p>
                   	</div>
							...
							<form class="form style-001 action="<?php echo url_for('@report') ?>" method="POST">
										...
										<fieldset>
							              ...
							              <?php endif ?>
												...
												<?php endif ?>
														<dt>
																<label for="comment">Report mistake</label>
														</dt>
