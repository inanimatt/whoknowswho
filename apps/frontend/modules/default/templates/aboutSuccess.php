...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@about') ?>">About</a></li>
</ul>
<?php end_slot();?>
			...
			<div class="span-4 last">
				...
				<div class="span-4 block-013">
					...
					<div class="span-4 block-016">
						<div class="span-4 header">
							<a href="<?php print url_for('@rules') ?>" class="link1">House Rules</a> 
							<a href="<?php print url_for('@terms') ?>" class="link2">Terms and Conditions</a> 
						</div>
