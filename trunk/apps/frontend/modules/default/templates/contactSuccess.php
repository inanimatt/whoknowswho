...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@contact') ?>">Contact</a></li>
</ul>
<?php end_slot();?>
		...
		<div class="span-12">
			...
			<div class="span-8">
				<div class="block-034">
					...
					<div class="search-string">
						<div class="inner clearfix">
							<p class="sIFR-c4">General enquiry</p>
							<p class="hidden">General enquiry</p>
						</div>
				...
				<div class="span-8 left-offset-white">
					<form class="form style-001 action="<?php echo url_for('@contact') ?>" method="POST">
