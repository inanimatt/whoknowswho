...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@terms') ?>">Terms and conditions</a></li>
</ul>
<?php end_slot();?>
<!--#MAIN CONTENT-->
...
<div id="content" class="span-12">
	<div class="span-12">
		...
		<div class="span-12" id="block-044">
			...
			<div class="inner">
				<h2 class="sIFR-c4">Terms and conditions</h2>
			</div>
			...
			<div class="span-4 last">
				<div class="span-4 block-013">
					...
					<div class="span-4 block-016">
						<div class="span-4 header"> <a href="<?php print url_for('@rules') ?>" class="link1">House Rules</a> <a href="<?php print url_for('@about') ?>" class="link2">About</a> </div>
