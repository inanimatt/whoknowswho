...
<ul>
    ...
    <li class="selected"><a href="<?php echo url_for('@report_comment') ?>">Report a comment</a></li>
</ul>
<?php end_slot();?>
...
<div class="span-12">
		...
		<div class="span-12" id="block-044">
			...
			<div class="inner">
				<h2 class="sIFR-c4">Report a comment</h2>
			</div>
		...
		<div class="span-12">
                ...
                <div class="search-string">
                		<div class="inner clearfix">
                   			<p class="sIFR-c4">Report a comment</p>
                     		<p class="hidden">Report a comment</p>
                   	</div>
						...
						<div class="span-8 left-offset-white">
							<form class="form style-001 action="<?php echo url_for('@report') ?>" method="POST">
										...
										<fieldset>
							              ...
							              <?php endif ?>
												...
												<?php endif ?>
														<dt>
																<label for="comment">Report a comment</label>
														</dt>
